<%@ Page Title="Submit Your Event" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EventReq.aspx.cs" Inherits="ELNET_PROJECT.Contact" %>
            ...
            <div class="row">
                <div class="col-md-6 mx-auto text-center">
                    ...
                    <div class="text-justify">
                        <p>Struggling with event management? Let us handle the heavy lifting for you! Whether it's a marathon, like the iconic Milo Marathon, or any other event, Dashbooking is your go-to solution.</p>
                        <p>Just fill out the details below, and we'll handle the rest! We'll set up a meeting to discuss how Dashbooking can make your event a success. Let's get started!</p>
                    </div>
                </div>
            </div>
            <div class="row">
